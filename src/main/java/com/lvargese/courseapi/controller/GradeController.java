...
public class GradeController {
    ...
    @GetMapping
    private ResponseEntity<PagedResponse<GradeDto>> getAllGrades(
            ...
            @RequestParam(defaultValue = "gradeId",required = false) String sortBy,
            @RequestParam(defaultValue = AppConstants.DEFAULT_SORT_DIR, required = false) String dir
    ){
        return ResponseEntity.ok(gradeService.getAllGrades(page, size, sortBy, dir));
    }
